...
- [7/12] 🔥 We release the [AlignGPT_family](https://github.com/AlignGPT-VL/AlignGPT_family), which supports a variety of large language models and visual backbones.
