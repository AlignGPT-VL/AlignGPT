...
We place all data for training in the `./playground/data` folder. Please download the [playground.zip]() from Alibaba Cloud Disk and unzip to `./playground/data`. The details are introduced below.
